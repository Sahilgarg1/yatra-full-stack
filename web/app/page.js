...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* Hero */}
      <div className="bg-dark-green px-8 pt-[52px] pb-[72px]">
        <div className="max-w-[640px] mx-auto">
          <div className="text-green text-[11px] font-semibold tracking-[0.1em] uppercase mb-3.5">
            India&apos;s trip comparison engine
          </div>
          <h1 className="font-display text-cream text-[40px] font-bold leading-[1.15] mb-3.5">
            Stop guessing.<br />Start{" "}
            <em className="text-gold not-italic">comparing</em>.
          </h1>
          <p className="text-text-light text-[15px] leading-[1.65] mb-9 max-w-[480px]">
      ...
      {/* Stats bar */}
      <div className="bg-beige-dark py-3 px-8 flex justify-center gap-12">
      ...
      {/* Main content */}
      <main className="max-w-[704px] mx-auto px-8 pt-12 w-full">
        {/* Articles */}
